        ...
        <section className="relative flex h-screen items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 px-4 text-center sm:px-6">
                ...
                <button
                    ...
                    className="rounded-full border border-white px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.25em] text-white transition-all hover:bg-white hover:text-black sm:px-8 sm:py-4 sm:text-xs"
                >
                    Explore Collection
                </button>
            </div>
